...
4. Change the date in [Rules](https://github.com/amelkisethian/100-days-of-code/blob/master/rules.md) to the day you've started the challenge.
5. Delete the log, or comment them out, and start filling it with your own content.
